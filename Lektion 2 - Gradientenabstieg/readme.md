...
Parallel zeigen wir auch eine Lösung via Trial and Error, die für dieses Problem genauso gut funktioniert. Wir werden jedoch zeitnah sehen, dass Trial and Error für große Deep-Learning-Systeme nicht funktionieren wird und wir Gradient Descent benötigen. Bis dahin also: 'Trust me bro/sister.' :D
