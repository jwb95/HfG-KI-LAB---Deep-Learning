...
2.) In bspw. Klassifikationsproblemen ist die Anzahl der Variablen im Output-Layer weitaus geringer als die des Input-Layers. Für ein Problem, bei dem ein Neuronales Netz voraussagen soll, ob ein RGB-Bild mit Seitenlängen 64x64 einen Hund oder eine Katze abbildet, hat das Input-Layer 64x64x3 = 12288 Variablen, das Output-Layer benötigt jedoch (je nach Design) nur 1 oder 2 Variablen. Also muss die Anzahl der Variablen an irgendeiner oder mehreren Stellen im Neural Network verringert werden.
